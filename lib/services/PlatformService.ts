...
export default class PlatformService {
	static async getAll() {
		try {
			...
			throw prismaError ?? { status: "error", statusCode: 500, errors: { generic: 'An internal server error has occurred while trying to retrieve platforms' } } as ResponseProps
		}
	}
}
